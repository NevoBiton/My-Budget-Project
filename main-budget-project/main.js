...
function darkModeExecute() {
    const darkModeIcon = document.querySelector('.icon-toggle');
    if (elemBody.classList.contains('dark-mode')) {
        elemBody.classList.remove('dark-mode')
        darkModeIcon.innerHTML = `<i class="fas fa-sun"></i>`
        localStorage.setItem("darkMode", false); 
    }
    else {
        elemBody.classList.add('dark-mode')
...
function initDarkMode() {
    const darkModeIcon = document.querySelector('.icon-toggle');
    JSON.parse(localStorage.getItem("darkMode")) == true ? elemBody.classList.add('dark-mode') : undefined;
    JSON.parse(localStorage.getItem("darkMode")) == true ? darkModeIcon.innerHTML = `<i class="fas fa-moon"></i>` : darkModeIcon.innerHTML = `<i class="fas fa-sun"></i>`;
}
